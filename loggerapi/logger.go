// This package contains a light wrapper around the etcd client's KeysAPI which
// logs the request and response for every etcd operation.
...
func New(c client.KeysAPI) client.KeysAPI {
	return &logger{c}
}
